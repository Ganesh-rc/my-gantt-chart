...
import { getTaskList3 } from "./ganttTasks03";
...
export const getTaskList2 = (): Task[] => {
  let tasks: Task[] = [
    ...
    },
    {
      ...
      end: new Date(2022, 6, 21, 9, 0),
      name: "Build Sprint 12",
      id: "Task 19",
      progress: 40,
    ...
    },
    {
      ...
      end: new Date(2022, 6, 19, 9, 0),
      name: "Testing",
      id: "Task 19.6",
      progress: 40,
      dependencies: ["Task 19.5"],
      type: "task",
      project: "Task 19",
    },
    {
